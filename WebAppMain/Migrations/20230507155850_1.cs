        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallsName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Computers_Halls_HallsId",
                        column: x => x.HallsId,
                        principalSchema: "Identity",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VisitingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateAndTimeOfTheVisit = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visiting_Services_ServicecId",
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "Identity",
                table: "Visiting",
                columns: new[] { "HallsId", "ComputerId", "DateAndTimeOfTheVisit" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Visiting_ServicecId",
                schema: "Identity",
                table: "Visiting",
                column: "ServicecId");
